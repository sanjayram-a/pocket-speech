...
const _onboardingKey = 'onboarding_v1_complete';
const _proPreviewKey = 'pro_preview_complete';
...
class ProPreviewController extends Notifier<bool> {
  @override
  bool build() =>
      ref.watch(appPreferencesProvider).getBool(_proPreviewKey) ?? false;

  Future<void> complete() async {
    state = true;
    await ref.read(appPreferencesProvider).setBool(_proPreviewKey, true);
  }
}

final proPreviewCompleteProvider = NotifierProvider<ProPreviewController, bool>(
  ProPreviewController.new,
);
